#' @title Initialize counters matrix
#' @description For experiences users only.
#' @param col2res Output from \code{\link{cmatrix}}
...
#' The function 'init_counters' in 'set_msa_score' (see \code{\link{cmatrix}}) uses 3D matrices,
...
init_counters <- function(col2res){
